...
<div class="col-lg-8 col-lg-offset-2">
	...
	<form action=" " method="post">
		...
		<div class="form-group">
			...
			<input class="form-control" required name="hostelname" id="hostelname" type="text">
		</div>
		<div class="form-group">
			...
			<div class="form-group">
				...
				<input class="form-control" required name="nationalId" id="nationalId" type="number">
			</div>
			<div class="form-group">
			...
			<div class="text-center">
				<button class="btn btn-primary" name="register" onclick="checkPassword()">Register</button>
			</div>
		</div>
